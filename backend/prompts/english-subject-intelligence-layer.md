...
English terms must never be divided only by textbook chapters.
Balance each term using appropriate combinations of:
Literature
Poetry
Reading
Reading Comprehension
...
Ensure continuous progression of:
Grammar
Vocabulary
Reading
Writing
...
Distribute Listening, Speaking, Projects, Portfolios and Assessments naturally across the academic year.
If the curriculum already provides Language R1/R2, Reading Modules, Writing Modules or similar structures, preserve them while planning the terms.

SESSION PLANNING INTELLIGENCE
Design sessions according to the identified instructional domain.
Never teach all English sessions in the same format.
...
↓
Revision
Where appropriate, integrate Reading, Writing, Speaking and Vocabulary instead of teaching them separately.
Teach Grammar contextually.
Teach Writing through modelling before independent practice.
Teach Literature through interpretation, discussion and appreciation rather than explanation alone.
