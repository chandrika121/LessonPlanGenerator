...
- Cell as a structural and • Explain the role of cells in the structure and
functional unit of life; functions of organisms
structure and function of • Explain activities inside the cell and its interactions
key organelles (nucleus, with the environment
mitochondria, • Demonstrate osmosis in cells
...
wall)
C-3.3 • Explain the role of cell division mitosis and meiosis
- Permeability of cell
in creating similarities and variations
membranes
- Cellular division and
C-4.2 • Identify and describe the role of biomolecules in the
cancer
structure and function of cell
- Recent advancement in
cell biology C-5.2 • Cite case study related to the use of science in
...
- Animal tissues
C-5.3 • Establish the correlation between different tissues
- Overview (epithelial,
...
and nervous tissues —
types, structure and
C-6.1 • Explain the importance of yoga exercises for
function of each)
physical agility and in maintaining the correct
- Elementary idea of
posture
musculoskeletal system
- Care of musculoskeletal C-6.1 • Discuss significant contributions of India, for
system: injuries, postural example, Professor Sipra Guha Mukherjee and
care, nutrition and Professor S.C. Maheshwari for their significant
exercise contribution in the plant cell and tissue culture
research in India
...
Types of asexual
C-3.2 • Compare asexual and sexual reproduction
reproduction with
...
reproduction
humans: male and
female reproductive C-4.3 • Identify and explain the role of biotic and abiotic
systems (structure and agents in seed dispersal and pollination
function, formation of
C-5.1 • Illustrate the structure of male and female
gametes, sperm and
...
hygiene • Introduction to C-6.1 • Describe the contribution of India to the
birth control methods understanding of human anatomy
and importance
C-6.1 • Discuss significant contributions of India, for
...
examples kingdoms, on the basis of their cellular organisation
- Major division of animals and ecological role
and plants • Describe the significance and rules of binomial
- Binomial nomenclature nomenclature
- Acellular entities: viruses • Apply binomial nomenclature on some common
organisms in their surroundings
C-2.8 • Analyse the interactions between members of
...
- Mass number standards, such as notations for electron, proton,
- Isotopes neutron, unified atomic mass unit (u), and
...
to IUPAC
C-5.1 • Draw labelled diagrams of various atomic models,
...
C-5.3 • Display awareness about the societal impact of
...
C-7.1 • Describe the use of the atomic mass unit (u) to
measure the mass of atoms as per IUPAC
recommendations
...
apparatus safely
C-5.1 • Draw diagrams of electron dot structures of atoms
and molecules
...
cycle, nitrogen cycle, different surfaces cause differential heating of the
oxygen cycle) Earth’s surface
- Human impact on • Identify various components of the Earth that
Earth’s system interact with solar energy
...
energy continuously between the non-living
...
C-8.1 • Draw flow charts, concept maps for
...
Key Concepts Learning Outcomes
- Concept of work; work C-2.5 • Define work done by a constant force and its SI
done by a constant force unit
- Work-Energy theorem • Calculate work done by a force using mathematical
- Mechanical energy, expression
kinetic and potential • State work-energy theorem
...
advantage (pulley, • Calculate kinetic and potential energy using
inclined plane, lever) mathematical expressions
